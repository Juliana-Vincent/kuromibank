...
const confirmTransfer = () => {
  ...
  return (
    <div className="dashboard w-full min-h-screen flex-col flex items-center justify-center">
      <h2 className="text-2xl font-bold mb-2">User Dashboard</h2>
      {user && <h3 className="text-xl mb-4">Welcome, {user}!</h3>}
      <div className="mb-6 text-lg">Your balance: <strong>${balance}</strong></div>
        ...
        <Grid size={{md: 6, sm:8}}>
          <div className="bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] shadow-[0_0_16px_0_rgba(0,0,0,0.5)] h-full rounded-2xl p-8">
            <div className='w-full flex justify-center'><h3 className='text-purple-600 text-2xl'>Send money</h3></div>
